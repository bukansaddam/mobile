...
class _ComplaintListPageState extends State<ComplaintListPage> {
  ...
  List<ComplaintItem> get _filteredComplaints {
    return dummyPublicComplaints.where((item) {
  ...
  void _showDetailBottomSheet(BuildContext context, ComplaintItem item) {
  ...
  Widget build(BuildContext context) {
    final filteredList = _filteredComplaints;
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              hintText: 'Cari pengaduan, lokasi, atau ID...',
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Coba kata kunci pencarian lain atau ubah filter status.',
