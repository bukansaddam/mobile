...
class _AddBankSampahReportScreenState extends State<AddBankSampahReportScreen> {
  ...
  void _submitReport() {
    ...
    final petugasNama = authState.user?.name ?? 'Petugas Linmas';

    context.read<BankSampahBloc>().add(
      AddBankSampahReportEvent(
          ...
          bottomNavigationBar: Container(
            ...
            child: SafeArea(
              child: ElevatedButton(
                onPressed: state.isSubmitting ? null : _submitReport,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          ...
                          items: BankSampahConstants.jenisSampahList.map((
                            jenis,
                          ) {
                    ...
                    _buildSectionHeader(
                      ...
                      subtitle:
                          'Masukkan bobot hasil penimbangan dalam kilogram',
                    ),
                    const SizedBox(height: 8),
                    TextFormField(
