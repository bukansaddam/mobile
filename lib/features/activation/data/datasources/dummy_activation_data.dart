...
class DummyActivationData {
  static final List<ActivationActivity> activities = [
    // 1. Sedang Berjalan (Pemasangan Perangkat)
    ActivationActivity(
      id: 'act-01',
      ...
      totalSteps: 5,
      description:
          'Penggelaran baliho pesan kebangsaan dan penataan media peraga visual di titik-titik strategis Kelurahan Menteng secara tertib.',
      notes:
      ...
      reports: [
        ActivationReport(
          ...
          longitude: 106.8317,
          notes:
              'Pemasangan kerangka kayu baliho di simpang kelurahan selesai (2 foto).',
        ),
        ActivationReport(
          id: 'rep-02',
          photoUrls: [
    ...
    // 2. Sedang Berjalan (Door to Door - Bansos)
    ActivationActivity(
      id: 'act-02',
      ...
      reports: [
        ActivationReport(
          ...
          notes:
              'Penyerahan paket bansos tahap 1 secara langsung kepada penerima.',
        ),
      ],
    ),

    // 3. Selesai (Pemasangan Perangkat)
    ActivationActivity(
      id: 'act-03',
      ...
      totalSteps: 5,
      description:
          'Pemasangan media baliho ucapan salam hangat dan pesan edukasi politik santun untuk masyarakat Kelurahan Tebet Barat.',
      notes:
      ...
      reports: [
        ActivationReport(
          ...
          submittedAt: DateTime(2026, 7, 11),
          latitude: -6.2300,
          longitude: 106.8400,
          notes: 'Survei titik lokasi.',
        ),
        ActivationReport(
          id: 'rep-06',
          photoUrls: [
          ...
          submittedAt: DateTime(2026, 7, 13),
          latitude: -6.2305,
          longitude: 106.8405,
          notes: 'Perakitan kerangka.',
        ),
        ActivationReport(
          id: 'rep-07',
          photoUrls: [
        ...
        ActivationReport(
          ...
          latitude: -6.2315,
          longitude: 106.8415,
          notes: 'Penguatan tiang penyangga.',
        ),
        ActivationReport(
          id: 'rep-09',
          photoUrls: [
          ...
          submittedAt: DateTime(2026, 7, 22),
          latitude: -6.2320,
          longitude: 106.8420,
          notes: 'Serah terima hasil pemasangan.',
        ),
      ],
    ),

    // 4. Terjadwal (Pemasangan Perangkat)
    ActivationActivity(
      id: 'act-04',
      ...
      totalSteps: 3,
      description:
          'Rencana penggelaran spanduk informasi program kerja kerakyatan di sudut-sudut strategis kelurahan.',
      notes: 'Menunggu distribusi bahan cetak spanduk dari logistik pusat.',
      reports: [],
    ),

    // 5. Dibatalkan (Door to Door - Bansos)
    ActivationActivity(
      id: 'act-05',
    ...
    // 6. Sedang Berjalan (Pemasangan Perangkat)
    ActivationActivity(
      id: 'act-06',
      ...
      totalSteps: 4,
      description:
          'Pemasangan baliho peraga yang memuat gagasan pembangunan wilayah dan ajakan menjaga kesatuan warga.',
      notes:
      ...
      reports: [
        ActivationReport(
          ...
          latitude: -6.1950,
          longitude: 106.8820,
          notes: 'Pengantaran material peraga.',
        ),
        ActivationReport(
          id: 'rep-11',
          photoUrls: [
          ...
          submittedAt: DateTime(2026, 7, 26),
          latitude: -6.1955,
          longitude: 106.8825,
          notes: 'Pemasangan tiang pancang (2 foto).',
        ),
      ],
    ),

    // 7. Terjadwal (Pemasangan Perangkat)
    ActivationActivity(
      id: 'act-07',
      ...
      totalSteps: 4,
      description:
          'Rencana penggelaran baliho penghormatan terhadap nilai-nilai kebersamaan bagi warga Kelurahan Kebon Sirih.',
      notes: 'Izin tempat dan koordinasi dengan pemilik lahan sudah tuntas.',
      reports: [],
    ),

    // 8. Selesai (Door to Door - Bansos)
    ActivationActivity(
      id: 'act-08',
    ...
    // 9. Sedang Berjalan (Pemasangan Perangkat)
    ActivationActivity(
      id: 'act-09',
      ...
      totalSteps: 3,
      description:
          'Pemasangan baliho bertema gotong royong dan kemandirian ekonomi warga Kelurahan Palmerah.',
      notes:
      ...
      reports: [
        ActivationReport(
          ...
          submittedAt: DateTime(2026, 7, 29, 16, 00),
          latitude: -6.1910,
          longitude: 106.7910,
          notes: 'Pengiriman peraga sampai di lokasi.',
        ),
      ],
    ),

    // 10. Terjadwal (Door to Door - Bansos)
    ActivationActivity(
      id: 'act-10',
    ...
    // 11. Dibatalkan (Pemasangan Perangkat)
    ActivationActivity(
      id: 'act-11',
      ...
      totalSteps: 3,
      description:
          'Pemasangan baliho peraga diurungkan karena adanya penataan ulang fungsi ruang terbuka hijau.',
      notes: 'Rencana dialihkan ke lokasi pemukiman Kelurahan Jatipulo.',
      reports: [],
    ),

    // 12. Sedang Berjalan (Pemasangan Perangkat)
    ActivationActivity(
      id: 'act-12',
      ...
      totalSteps: 4,
      description:
          'Pemasangan media kain spanduk berisi pesan perdamaian dan kerukunan warga di kawasan Cempaka Putih.',
      notes:
      ...
      reports: [
        ...
        ActivationReport(
          ...
          latitude: -6.1785,
          longitude: 106.8685,
          notes: 'Pemasangan spanduk pertama.',
        ),
      ],
    ),

    // 13. Selesai (Pemasangan Perangkat)
    ActivationActivity(
      id: 'act-13',
      ...
      totalSteps: 3,
      description:
          'Pemasangan peraga baliho ukuran besar secara aman di area persimpangan Kelurahan Duren Sawit.',
      ...
      reports: [
        ...
        ActivationReport(
          ...
          latitude: -6.2220,
          longitude: 106.9020,
          notes: 'Pemeriksaan akhir (2 foto).',
        ),
      ],
    ),

    // 14. Terjadwal (Door to Door - Bansos)
    ActivationActivity(
      id: 'act-14',
    ...
    // 15. Sedang Berjalan (Pemasangan Perangkat)
    ActivationActivity(
      id: 'act-15',
      ...
      totalSteps: 3,
      description:
          'Sosialisasi visual melalui baliho mengenai pentingnya partisipasi aktif warga dalam pesta demokrasi.',
      ...
      reports: [
        ActivationReport(
          ...
          latitude: -6.2250,
          longitude: 106.8650,
          notes: 'Pemasangan fondasi awal.',
        ),
      ],
    ),

    // 16. Terjadwal (Pemasangan Perangkat)
    ActivationActivity(
      id: 'act-16',
      ...
      totalSteps: 5,
      description:
          'Pemasangan baliho peraga yang menampilkan komitmen pengembangan potensi kreativitas pemuda lokal.',
      notes:
          'Lokasi titik penempatan sudah dikonfirmasi dengan masyarakat setempat.',
      reports: [],
    ),

    // 17. Selesai (Door to Door - Bansos)
    ActivationActivity(
      id: 'act-17',
    ...
    // 18. Sedang Berjalan (Pemasangan Perangkat)
    ActivationActivity(
      id: 'act-18',
      ...
      totalSteps: 4,
      description:
          'Penataan baliho gambar pesan ramah dan optimisme pembangunan daerah untuk warga Kebayoran Lama.',
      notes:
      ...
      reports: [
        ActivationReport(
          ...
          submittedAt: DateTime(2026, 7, 25),
          latitude: -6.2700,
          longitude: 106.7780,
          notes: 'Bahan kayu siap.',
        ),
        ActivationReport(
          id: 'rep-27',
          photoUrls: [
        ...
        ActivationReport(
          ...
          latitude: -6.2710,
          longitude: 106.7790,
          notes: 'Baliho terpasang.',
        ),
      ],
    ),

    // 19. Terjadwal (Door to Door - Bansos)
    ActivationActivity(
      id: 'act-19',
    ...
    // 20. Selesai (Pemasangan Perangkat)
    ActivationActivity(
      id: 'act-20',
      ...
      totalSteps: 2,
      description:
          'Pemasangan spanduk imbauan kebersihan lingkungan dan kebersamaan warga Kelurahan Pancoran.',
      ...
      reports: [
        ...
        ActivationReport(
          ...
          latitude: -6.2485,
          longitude: 106.8485,
          notes: 'Pengikatan sisi kanan.',
        ),
      ],
    ),

    // 21. Dibatalkan (Pemasangan Perangkat)
    ActivationActivity(
      id: 'act-21',
      ...
      totalSteps: 4,
      description:
          'Pemasangan baliho dibatalkan atas pertimbangan teknis efisiensi pemanfaatan media peraga.',
      notes: 'Bahan cetak baliho disimpan kembali di gudang logistik posko.',
      reports: [],
    ),

    // 22. Sedang Berjalan (Pemasangan Perangkat)
    ActivationActivity(
      id: 'act-22',
      ...
      totalSteps: 5,
      description:
          'Pemasangan baliho peraga sosialisasi gagasan perubahan positif untuk kesejahteraan masyarakat Kelurahan Cilincing.',
      ...
      reports: [
        ActivationReport(
          ...
          latitude: -6.1120,
          longitude: 106.9120,
          notes: 'Pemasangan tiang utama.',
        ),
      ],
    ),

    // 23. Terjadwal (Door to Door - Bansos)
    ActivationActivity(
      id: 'act-23',
